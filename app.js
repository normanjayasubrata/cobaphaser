...
function preload() {
    ...
    game.load.spritesheet('mario', 'myassets/mariospritesheet-small.png',50,50); // key, sourcefile, framesize x, framesize y
    //background, ground, fireball images
    game.load.image('ground', 'myassets/2048x48-ground.png');
    game.load.image('clouds', 'myassets/clouds.jpg');
    game.load.image('fireball', 'myassets/fireball.png',40,30);
    //gamepad buttons
    game.load.spritesheet('buttonvertical', 'myassets/buttons/buttons-big/button-vertical.png',64,64);
    game.load.spritesheet('buttonhorizontal', 'myassets/buttons/buttons-big/button-horizontal.png',96,64);
    game.load.spritesheet('buttondiagonal', 'myassets/buttons/buttons-big/button-diagonal.png',64,64);
    game.load.spritesheet('buttonfire', 'myassets/buttons/buttons-big/button-round-a.png',96,96);
    game.load.spritesheet('buttonjump', 'myassets/buttons/buttons-big/button-round-b.png',96,96);
    // fullscreen setup
